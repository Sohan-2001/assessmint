...
type QuestionFormValues = z.infer<typeof questionSchema>; // Used for default question structure

// Helper component for rendering each question's options
function QuestionOptions({ control, questionIndex, questionType }: { control: any, questionIndex: number, questionType: QuestionFormValues['type'] }) {
  ...
  const handleAddOption = () => {
    appendOption({ text: "" }); // ID will be auto-generated by Zod default
  };
                      ...
                      <FormItem>
                        ...
                        <Select 
                          onValueChange={(value) => {
                            ...
                            // When type changes, reset options and correctAnswer if not MCQ
                            if (value !== 'MULTIPLE_CHOICE') {
                              form.setValue(`questions.${questionIndex}.options`, []);
                              form.setValue(`questions.${questionIndex}.correctAnswer`, undefined);
                            } else {
                              // If changing to MCQ and no options exist, add default options
